import './App.css';
import logo from './shared/reactnativejs.png'
import {
...
import Es6 from './modulse/ES/Es6';
import LifeSycle from './modulse/React/LifeSycle';
import { useState } from 'react';
import Style from './modulse/css/Style';
const selctedClass = "flex items-center py-2 px-8 bg-gray-700 text-gray-100 border-r-4 border-gray-100"
const normalClass = "flex items-center  py-2 px-8 text-gray-400 border-r-4 border-gray-800 hover:bg-gray-700 hover:text-gray-100 hover:border-gray-100"
function App() {
    ...
    return (
        <div className="App">
                ...
                <header className="fixed bg-white w-full shadow text-gray-600 body-font">
                    <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row justify-center items-center">
                        <a className="flex title-font text-base items-center text-gray-900 mb-4 md:mb-0">
                            <img className='h-10 rounded-xl' src={logo} />
                            <span className="ml-3 text-xl uppercase" style={{ fontFamily: 'Ubuntu' }}>Reactnativejs</span>
                        </a>

                    </div>
                </header>
                <div className="container mx-auto flex flex-wrap p-6 flex-col md:flex-row items-center">a</div>
                {/* <div className="bg-gray-200">
                    <div className="flex flex-col sm:flex-row sm:justify-start"> */}

                {/* <div clsassName="w-64  bg-gray-800 mt-8 sm:mt-0"> */}
                <div className="flex items-center justify-center mt-2">
                    <span className="ml-3 text-white text-xl" style={{ fontFamily: 'Ubuntu' }}>Reactnativejs</span>
                </div>
                    ...
                    <ul className='navbar-nav'>
                        <li class="logo">
                            <a href="#" class="nav-link">
                                <span class="link-text logo-text">reactnativejs</span>
                                <svg
                                    aria-hidden="true"
                                    focusable="false"
                                    data-prefix="fad"
                        ...
                        <li className='nav-item'>
                            <Link className='nav-link' to="/">
                                ...
                                <span className="link-text">Javascript ES6</span>
                            </Link>
                        </li>
                        <li className='nav-item'>
                            ...
                            <Link className='nav-link' to="style">
                                ...
                                <span className="link-text">Style</span>
                            </Link>
                        </li>
                        <li className='nav-item'>
                            ...
                            <Link className='nav-link' to="lifecycle">
                                ...
                                <span className="link-text">Lifecycle</span>
                            </Link>
                        </li>
                        <li className='nav-item'>
                            <a className='nav-link' href="https://fontawesome.com/license">


                            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="info-circle" class="svg-inline--fa fa-info-circle fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M256 8C119.043 8 8 119.083 8 256c0 136.997 111.043 248 248 248s248-111.003 248-248C504 119.083 392.957 8 256 8zm0 110c23.196 0 42 18.804 42 42s-18.804 42-42 42-42-18.804-42-42 18.804-42 42-42zm56 254c0 6.627-5.373 12-12 12h-88c-6.627 0-12-5.373-12-12v-24c0-6.627 5.373-12 12-12h12v-64h-12c-6.627 0-12-5.373-12-12v-24c0-6.627 5.373-12 12-12h64c6.627 0 12 5.373 12 12v100h12c6.627 0 12 5.373 12 12v24z"></path></svg>                                <span className="link-text">Credits</span>
                            </a>
                        </li>
                    </ul>
                </nav>
                {/* </div> */}
                <main classsName="flex-1 flex-wrap  bg-white">
                    <Switch>
                        <Route exact path="/">
                            <Es6 />
                        </Route>
